...
const vid = ['https://files.catbox.moe/falp8a.mp4', 'https://qu.ax/zocRc.mp4', 'https://qu.ax/MTRuP.mp4']
...
await m.reply(`✘ Ocurrió un error al enviar mi lista de comandos...\n\n${e}`)
await m.react(error)
}}
